...
public class Nhap_hang extends javax.swing.JFrame {
    ...
    public Nhap_hang() {
        ...
        getDataCombobox();
        setTitle("HKT SHOE SHOP - Thoải mái trong từng bước chân!");
    ...
    private void initComponents() {
        ...
        btn_quanly.setText("HKT SHOE SHOP");
        ...
        jPanel1.add(txt_NgayNhap, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 200, 280, -1));
                    ...
                    if (isAfterNow(a)) {
                        ...
                        for (SanPham sp : daoSP.sanphamlist) {
                            if (sp.getMaSp().equals(txt_MaSp.getText().trim()) && sp.getNgayNhap().equals(a)) {
                              sp.setSoluong(sp.getSoluong() + Integer.parseInt(txt_SoLuong.getText().trim()));
                               isExist = true;
                              break;
}
